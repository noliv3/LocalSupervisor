...
if ($logsRoot === null) {
    sv_log_system_error($config, 'forge_service_log_root_unavailable', ['error' => $logsError]);
...
$serviceName = 'forge_service';
$heartbeatPath = $logsRoot . '/forge_service.heartbeat.json';
$limit = 1;
$sleepMs = (int)($config['workers']['forge']['sleep_ms'] ?? 1500);
if ($sleepMs < 100) {
    $sleepMs = 100;
}
