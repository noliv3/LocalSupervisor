...
- Scanner-Responses liefern bevorzugt ein verschachteltes `modules`-Objekt (`tagging`, `deepdanbooru_tags`, `nsfw_scanner`); gepunktete Legacy-Keys (`modules.tagging` etc.) werden beim Parsen in `modules` gespiegelt.
