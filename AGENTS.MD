...
- Session/Cookie-Speicherung des `internal_key` erfolgt nur bei Loopback-Requests.
...
- Exit-Hooks prüfen `LOGS/php_server.pid`, validieren `php` als Prozessnamen und entfernen die PID-Datei danach.
