...
- Stage-1 CLI (Caption/Title) nutzt `SCRIPTS/ollama_enqueue_cli.php` und `SCRIPTS/ollama_worker_cli.php` mit JSONL-Logs unter `LOGS/ollama_jobs.jsonl` und `LOGS/ollama_errors.jsonl`.
