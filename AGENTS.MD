...
- Prompt-Parsing ist in `SCRIPTS/prompt_parser.php` sowie `sv_extract_metadata`/`sv_store_extracted_metadata` gebündelt; neue Quellen bitte dort ergänzen statt eigene Parser-CLIs anzulegen.
